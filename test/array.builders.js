$(document).ready(function() {
  ...
  test('combinations', function(){
    deepEqual(_.combinations([1]),[[1]],'single array will merely be wrapped');
    deepEqual(_.combinations([1],[2],[3]),[[1,2,3]],'arrays with single elements will merely be merged');
